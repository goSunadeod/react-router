...
## 简单代码实现HashHashRouter，Route，Link，Redirect，Switch，params
...
While Jest provides browser globals such as `window` thanks to [jsdom](https://github.com/tmpvar/jsdom), they are only approximations of the real browser behavior. Jest is 
